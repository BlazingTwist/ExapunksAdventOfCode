...
function getTitle() {
    return "Day 1.1 : Calorie Counting";
}
...
function initializeTestRun(testRun) {
    ...
    let captainGoal = requireCustomGoal("Report max inventory to Captain");
...
function getBookKeeperData(testRun) {
    if (testRun === 1) {
        ...
        return [1111, 1112, 1113, "", 1114, 1115, 1116, "", 1122]
    } else if (testRun === 4) {
        return [3000, "", 999, 999, 999, 999]
    } else if (testRun === 5) {
