...
function getDescription() {
    return ""
        ...
        + "Write the number of fully overlapping pairs to the Message Board #MBRD for all the Elves to see."
        ;
}
...
function initializeTestRun(testRun) {
    ...
    let messageBoardGoal = requireCustomGoal("Write number of full overlaps to #MBRD.");
    let messageBoardTerminal = createWindow("MessageBoard Terminal", 0, 11, 40, 2);
    printWindow(messageBoardTerminal, "Awaiting number of full overlaps...");
